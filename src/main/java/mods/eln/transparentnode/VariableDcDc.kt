...
class VariableDcDcElement(transparentNode: TransparentNode, descriptor: TransparentNodeDescriptor): TransparentNodeElement(transparentNode, descriptor), IConfigurable {
    ...
    private fun computeInventory() {
        ...
        if (primaryCable == null || !hasValidCore || primaryCable.getCount() < 4) {
        ...
        if (secondaryCable == null || !hasValidCore || secondaryCable.getCount() < 4) {
        ...
        populated = primaryCable != null && secondaryCable != null && primaryCable.getCount() >= 4 && secondaryCable.getCount() >= 4 && hasValidCore
    }
