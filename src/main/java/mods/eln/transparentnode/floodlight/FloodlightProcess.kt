...
class FloodlightProcess(var element: FloodlightElement) : IProcess {
    ...
    private fun placeSpots(lightValue: Int) {
        ...
        for (idx in 0 until rotationVectors.size) {
            ...
            for (jdx in 0 until throwDistance.toInt()) {
                lightVector.pos.x += rotationVectors[idx].first.pos.x
                lightVector.pos.y += rotationVectors[idx].first.pos.y
                lightVector.pos.z += rotationVectors[idx].first.pos.z
    ...
    */
    ...
    private fun getRawRotationVector(horzAngle: Double, vertAngle: Double): Vec3 {
        ...
        v.pos.x = vertCos * horzSin
        v.pos.y = vertSin
        v.pos.z = vertCos * horzCos
        ...
        when (axis) {
            XN -> {
                ...
                when (facing) {
                    ...
                    YN -> {
                        newV.pos.y = -oldV.pos.z
                        newV.pos.z = oldV.pos.x
                    }
                    YP -> {
                        newV.pos.y = oldV.pos.z
                        newV.pos.z = -oldV.pos.x
                    ...
                    ZN -> {
                        newV.pos.y = -oldV.pos.x
                        newV.pos.z = -oldV.pos.z
                    }
                    ZP -> {
                        newV.pos.y = oldV.pos.x
                        newV.pos.z = oldV.pos.z
            ...
            YN -> {
                newV.pos.y = -oldV.pos.y

                when (facing) {
                    XN -> {
                        newV.pos.x = -oldV.pos.z
                        newV.pos.z = -oldV.pos.x
                    }
                    XP -> {
                        newV.pos.x = oldV.pos.z
