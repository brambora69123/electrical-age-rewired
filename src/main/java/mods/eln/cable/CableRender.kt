...
object CableRender {
    ...
    fun connectionType(element: SixNodeElementRender, side: Direction): CableRenderType {
        ...
        for (lrdu in LRDU.values()) {
            ...
            x2 = element.tileEntity.pos.x
            y2 = element.tileEntity.pos.y
            z2 = element.tileEntity.pos.z
            when (sideLrdu) {
                Direction.XN -> x2--
                Direction.XP -> x2++
                Direction.YN -> y2--
    ...
    fun drawCable(
        ...
        if (endLeft < startLeft) {
            ...
            GL11.glTepos.x2f(tx + (cable.widthDiv2 + height) * 0.5f, ty + endLeft)
            GL11.glVertex3f(0f, cable.widthDiv2, endLeft)
            GL11.glTepos.x2f(tx + (cable.widthDiv2 + height) * 0.5f, ty + startLeft)
            GL11.glVertex3f(0f, cable.widthDiv2, startLeft)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endLeft)
            GL11.glVertex3f(height, cable.widthDiv2, endLeft)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + startLeft)
            ...
            GL11.glVertex3f(height, -cable.widthDiv2, startLeft)
            GL11.glNormal3f(0f, -1f, 0f)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f - height, ty + endLeft)
            GL11.glVertex3f(0f, -cable.widthDiv2, endLeft)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f - height, ty + startLeft)
            GL11.glVertex3f(0f, -cable.widthDiv2, startLeft)
            if (drawBottom) {
                GL11.glNormal3f(0f, 1f, 0f)
                GL11.glTepos.x2f(tx + (cable.widthDiv2 + height) * 0.5f, ty + endLeft)
            ...
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + endLeft - height)
            GL11.glVertex3f(0f, -cable.widthDiv2, endLeft)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endLeft - height)
            GL11.glVertex3f(0f, cable.widthDiv2, endLeft)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endLeft)
        ...
        if (endRight > startRight) {
            GL11.glBegin(GL11.GL_QUAD_STRIP)
            GL11.glNormal3f(0f, 1f, 0f)
            GL11.glTepos.x2f(tx + (cable.widthDiv2 + height) * 0.5f, ty + startRight)
            GL11.glVertex3f(0f, cable.widthDiv2, startRight)
            GL11.glTepos.x2f(tx + (cable.widthDiv2 + height) * 0.5f, ty + endRight)
            GL11.glVertex3f(0f, cable.widthDiv2, endRight)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + startRight)
            GL11.glVertex3f(height, cable.widthDiv2, startRight)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endRight)
            ...
            GL11.glVertex3f(height, -cable.widthDiv2, endRight)
            GL11.glNormal3f(0f, -1f, 0f)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f - height, ty + startRight)
            GL11.glVertex3f(0f, -cable.widthDiv2, startRight)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f - height, ty + endRight)
            GL11.glVertex3f(0f, -cable.widthDiv2, endRight)
            if (drawBottom) {
                GL11.glNormal3f(0f, 1f, 0f)
                GL11.glTepos.x2f(tx + (cable.widthDiv2 + height) * 0.5f, ty + startRight)
            ...
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endRight)
            GL11.glVertex3f(height, cable.widthDiv2, endRight)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endRight + height)
            GL11.glVertex3f(0f, cable.widthDiv2, endRight)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + endRight + height)
            GL11.glVertex3f(0f, -cable.widthDiv2, endRight)
            GL11.glEnd()
        ...
        if (endDown < startDown) {
            GL11.glBegin(GL11.GL_QUAD_STRIP)
            GL11.glNormal3f(0f, 0f, -1f)
            GL11.glTepos.x2f(tx - (cable.widthDiv2 - height) * 0.5f, ty + endDown)
            GL11.glVertex3f(0f, endDown, -cable.widthDiv2)
            GL11.glTepos.x2f(tx - (cable.widthDiv2 - height) * 0.5f, ty + startDown)
            GL11.glVertex3f(0f, startDown, -cable.widthDiv2)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + endDown)
            GL11.glVertex3f(height, endDown, -cable.widthDiv2)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + startDown)
            ...
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endDown)
            GL11.glVertex3f(height, endDown, cable.widthDiv2)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endDown - height)
            GL11.glVertex3f(0f, endDown, cable.widthDiv2)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + endDown - height)
            GL11.glVertex3f(0f, endDown, -cable.widthDiv2)
            GL11.glEnd()
        ...
        if (endUp > startUp) {
            GL11.glBegin(GL11.GL_QUAD_STRIP)
            GL11.glNormal3f(0f, 0f, -1f)
            GL11.glTepos.x2f(tx - (cable.widthDiv2 - height) * 0.5f, ty + startUp)
            GL11.glVertex3f(0f, startUp, -cable.widthDiv2)
            GL11.glTepos.x2f(tx - (cable.widthDiv2 - height) * 0.5f, ty + endUp)
            GL11.glVertex3f(0f, endUp, -cable.widthDiv2)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + startUp)
            GL11.glVertex3f(height, startUp, -cable.widthDiv2)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + endUp)
            ...
            GL11.glBegin(GL11.GL_QUADS)
            GL11.glNormal3f(0f, 1f, 0f)
            GL11.glTepos.x2f(tx - cable.widthDiv2 * 0.5f, ty + endUp + height)
            GL11.glVertex3f(0f, endUp, -cable.widthDiv2)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endUp + height)
            GL11.glVertex3f(0f, endUp, cable.widthDiv2)
            GL11.glTepos.x2f(tx + cable.widthDiv2 * 0.5f, ty + endUp)
    ...
    fun drawNode(cable: CableRenderDescriptor, connection: LRDUMask, @Suppress("UNUSED_PARAMETER") connectionType: CableRenderType?) {
        if (connection.mask == 0 || (connection[LRDU.Left] || connection[LRDU.Right]) && (connection[LRDU.Down] || connection[LRDU.Up]) || connection.mask == 1 || connection.mask == 2 || connection.mask == 4 || connection.mask == 8) {
            ...
            GL11.glBegin(GL11.GL_QUAD_STRIP)
            GL11.glNormal3f(0f, 1f, 0f)
            GL11.glTepos.x2f(tx + (widthDiv2 + cable.height + 1.0f / 16.0f) * 0.5f, ty - widthDiv2)
            GL11.glVertex3f(0f, widthDiv2, -widthDiv2)
            GL11.glTepos.x2f(tx + (widthDiv2 + cable.height + 1.0f / 16.0f) * 0.5f, ty + widthDiv2)
            GL11.glVertex3f(0f, widthDiv2, widthDiv2)
            GL11.glTepos.x2f(tx + widthDiv2 * 0.5f, ty - widthDiv2)
            ...
            GL11.glBegin(GL11.GL_QUADS)
            GL11.glNormal3f(0f, 0f, -1f)
            GL11.glTepos.x2f(tx - widthDiv2 * 0.5f, ty - widthDiv2 - cable.height - 1.0f / 16.0f)
            GL11.glVertex3f(0f, -widthDiv2, -widthDiv2)
            GL11.glTepos.x2f(tx + widthDiv2 * 0.5f, ty - widthDiv2 - cable.height - 1.0f / 16.0f)
            GL11.glVertex3f(0f, widthDiv2, -widthDiv2)
            GL11.glTepos.x2f(tx + widthDiv2 * 0.5f, ty - widthDiv2)
