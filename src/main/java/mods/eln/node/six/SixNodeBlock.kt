...
(material: Material?, tileEntityClass: Class<*>?) : NodeBlock(material, tileEntityClass!!, 0) {
    ...
    override fun collisionRayTrace(world: World, x: Int, y: Int, z: Int, start: Vec3, end: Vec3): MovingObjectPosition? {
        ...
        // XN
        if (isIn(x.toDouble(), end.pos.x, start.pos.x) && booltemp[0]) {
            val hitX: Double
            val hitY: Double
            val hitZ: Double
            val ratio: Double
            ratio = (x - start.pos.x) / (end.pos.x - start.pos.x)
            if (ratio <= 1.1) {
                hitX = start.pos.x + ratio * (end.pos.x - start.pos.x)
                hitY = start.pos.y + ratio * (end.pos.y - start.pos.y)
                hitZ = start.pos.z + ratio * (end.pos.z - start.pos.z)
        ...
        // XP
        if (isIn((x + 1).toDouble(), start.pos.x, end.pos.x) && booltemp[1]) {
            val hitX: Double
            val hitY: Double
            val hitZ: Double
            val ratio: Double
            ratio = (x + 1 - start.pos.x) / (end.pos.x - start.pos.x)
            if (ratio <= 1.1) {
                hitX = start.pos.x + ratio * (end.pos.x - start.pos.x)
                hitY = start.pos.y + ratio * (end.pos.y - start.pos.y)
                hitZ = start.pos.z + ratio * (end.pos.z - start.pos.z)
        ...
        // YN
        if (isIn(y.toDouble(), end.pos.y, start.pos.y) && booltemp[2]) {
            val hitX: Double
            val hitY: Double
            val hitZ: Double
            val ratio: Double
            ratio = (y - start.pos.y) / (end.pos.y - start.pos.y)
            if (ratio <= 1.1) {
                hitX = start.pos.x + ratio * (end.pos.x - start.pos.x)
                hitY = start.pos.y + ratio * (end.pos.y - start.pos.y)
                hitZ = start.pos.z + ratio * (end.pos.z - start.pos.z)
        ...
        // YP
        if (isIn((y + 1).toDouble(), start.pos.y, end.pos.y) && booltemp[3]) {
            val hitX: Double
            val hitY: Double
            val hitZ: Double
            val ratio: Double
            ratio = (y + 1 - start.pos.y) / (end.pos.y - start.pos.y)
            if (ratio <= 1.1) {
                hitX = start.pos.x + ratio * (end.pos.x - start.pos.x)
                hitY = start.pos.y + ratio * (end.pos.y - start.pos.y)
                hitZ = start.pos.z + ratio * (end.pos.z - start.pos.z)
        ...
        // ZN
        if (isIn(z.toDouble(), end.pos.z, start.pos.z) && booltemp[4]) {
            val hitX: Double
            val hitY: Double
            val hitZ: Double
            val ratio: Double
            ratio = (z - start.pos.z) / (end.pos.z - start.pos.z)
            if (ratio <= 1.1) {
                hitX = start.pos.x + ratio * (end.pos.x - start.pos.x)
                hitY = start.pos.y + ratio * (end.pos.y - start.pos.y)
                hitZ = start.pos.z + ratio * (end.pos.z - start.pos.z)
        ...
        // ZP
        if (isIn((z + 1).toDouble(), start.pos.z, end.pos.z) && booltemp[5]) {
            val hitX: Double
            val hitY: Double
            val hitZ: Double
            val ratio: Double
            ratio = (z + 1 - start.pos.z) / (end.pos.z - start.pos.z)
            if (ratio <= 1.1) {
                hitX = start.pos.x + ratio * (end.pos.x - start.pos.x)
                hitY = start.pos.y + ratio * (end.pos.y - start.pos.y)
                hitZ = start.pos.z + ratio * (end.pos.z - start.pos.z)
    ...
    fun collisionRayTrace(world: World, x: Int, y: Int, z: Int, entityLiving: EntityPlayer): MovingObjectPosition? {
        ...
        if (!world.isRemote) start.pos.y += 1.62
        val var5 = entityLiving.getLook(0.5f)
        val end = start.addVector(var5.pos.x * distanceMax, var5.pos.y * distanceMax, var5.pos.z * distanceMax)
    ...
    private fun faceFacingPlayerScore(direction: Direction, look: Vec3): Double {
        ...
        return -(look.pos.x * nx + look.pos.y * ny + look.pos.z * nz)
    }
