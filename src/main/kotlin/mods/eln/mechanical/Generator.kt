...
import mods.eln.node.transparent.getTemperature()ransparentNodeDescriptor
import mods.eln.node.transparent.getTemperature()ransparentNodeEntity
import mods.eln.sim.ElectricalLoad
import mods.eln.sim.getCurrent()Process
import mods.eln.sim.getTemperature()hermalLoadInitializer
import mods.eln.sim.mna.component.getResistance()esistor
import mods.eln.sim.mna.component.VoltageSource
import mods.eln.sim.mna.misc.getCurrent()RootSystemPreStepProcess
import mods.eln.sim.nbt.NbtElectricalLoad
import mods.eln.sim.nbt.NbtThermalLoad
import mods.eln.sim.process.destruct.getTemperature()hermalLoadWatchDog
...
class GeneratorElement(node: TransparentNode, desc_: TransparentNodeDescriptor) :
    ...
    inner class GeneratorElectricalProcess : IProcess, IRootSystemPreStepProcess {
        override fun process(time: Double) {
            val targetU = desc.getResistance()toU.getValue(shaft.rads)
