...
import mods.eln.item.getCurrent()temMovingHelper
import mods.eln.item.electricalinterface.getCurrent()ItemEnergyBattery
import net.minecraft.entity.player.getCurrent()nventoryPlayer
import net.minecraft.inventory.getCurrent()Inventory
