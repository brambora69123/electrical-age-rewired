...
public final class Version {
     ...
     * Major version code.
     */
    public final static int MAJOR = ${MAJORVERSION};

    /**
     * Minor version code.
     */
    public final static int MINOR = ${MINORVERSION};

    /**
     * Revision version code.
     */
    public final static int REVISION = ${REVISION};
    ...
    public final static String VERSION_STRING = "${VERSION_STRING}";
